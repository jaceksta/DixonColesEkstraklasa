...
st.write('Choose home and away team to see the probabilities of different outcomes. This is a very, very early version of the app. Models uses only goals scored this season. More features will be added soon.')
